<template>
    <form @submit.prevent="EditCourse()" method="put">
        <div class="container" id="container">
            <div class="modal">
                <div class="modal__header">
                    <span class="modal__title">Edit course</span><button class="button button--icon"><svg width="24"
                ...
                <div class="modal__body">
                    <div class="input">
                        ...
                        <input class="input__field" type="text" id="name" v-model="editCourse.name">
                    ...
                    <div class="input">
                        ...
                        <textarea class="input__field input__field--textarea" id="description"
                            v-model="editCourse.description"></textarea>
                    ...
                    <div class="input">
                        ...
                        <input class="input__field" type="text" id="image" v-model="editCourse.image">
                        <p class="input__description">The title must contain a maximum of 32 characters</p>
                    </div>
                </div>
                <div class="modal__footer">
                    <button type="submit" class="button button--primary">Submit course</button>
                </div>
            </div>
        </div>
    </form>
...
export default {
    ...
    methods: {
        ...
        async assignValues() {
            ...
            this.editCourse.id = res.data._id;
            this.editCourse.name = res.data.name;
            this.editCourse.description = res.data.description;
            this.editCourse.image = res.data.image;
